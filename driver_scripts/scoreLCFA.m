function [scoremat,datametaC,datamatVC,datameta,datamatV,datamatN,datamatS,...
          ...
          =scoreLCFA(cond_file,array_file,data_path,format,ignore,bad,type,keio6ind)
...
%-- score the data
[scoremat,datametaC]=calculate_score_LCFA(datamatFscaled,datamatVscaled,datametaC,variance_limit,numDup);